...
public class ParallaxEffectRelativeToCamara : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        transform.position = new Vector3(transform.position.x, cameraTransform.position.y + axisYOffset, transform.position.z);
    }
}
